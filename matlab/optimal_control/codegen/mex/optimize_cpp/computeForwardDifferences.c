...
boolean_T computeForwardDifferences(e_struct_T *obj, real_T fCurrent, const
  ...
  const emxArray_real_T *lb, const emxArray_real_T *ub)
{
  ...
  while ((!exitg1) && (idx <= obj->nVar - 1)) {
    ...
    ubDiff = b_anon(obj->objfun.tunableEnvironment.f1,
                    ...
                    obj->objfun.tunableEnvironment.f3.b,
                    obj->objfun.tunableEnvironment.f3.p_a1,
                    obj->objfun.tunableEnvironment.f3.p_a2,
                    obj->objfun.tunableEnvironment.f3.g,
                    obj->objfun.tunableEnvironment.f3.w1,
                    obj->objfun.tunableEnvironment.f3.w2,
                    obj->objfun.tunableEnvironment.f3.T_th, xk);
    evalOK = ((!muDoubleScalarIsInf(ubDiff)) && (!muDoubleScalarIsNaN(ubDiff)));
    if (evalOK) {
      anon(obj->nonlin.tunableEnvironment.f1, obj->nonlin.tunableEnvironment.f2,
           obj->nonlin.tunableEnvironment.f3, obj->nonlin.tunableEnvironment.f5,
           &obj->nonlin.tunableEnvironment.f6, xk, varargout_1);
      i = r->size[0];
      r->size[0] = obj->cIneq_1->size[0];
      emxEnsureCapacity_real_T(r, i);
      b_idx = obj->cIneq_1->size[0];
      ...
      if (!modifiedStep) {
        ...
        if ((!obj->hasBounds) || modifiedStep) {
          ...
          evalOK = ((!muDoubleScalarIsInf(ubDiff)) && (!muDoubleScalarIsNaN
                     (ubDiff)));
          if (evalOK) {
            anon(obj->nonlin.tunableEnvironment.f1,
                 obj->nonlin.tunableEnvironment.f2,
                 obj->nonlin.tunableEnvironment.f3,
                 obj->nonlin.tunableEnvironment.f5,
                 &obj->nonlin.tunableEnvironment.f6, xk, varargout_1);
            i = obj->cIneq_1->size[0];
            obj->cIneq_1->size[0] = r->size[0];
            emxEnsureCapacity_real_T(obj->cIneq_1, i);

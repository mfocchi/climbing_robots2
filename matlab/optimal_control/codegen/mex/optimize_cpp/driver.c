    ...
    while (!(Flags.stepAccepted || Flags.failedLineSearch)) {
      ...
      if (Flags.stepAccepted) {
        ...
        phi_alpha = b_anon(FcnEvaluator->objfun.tunableEnvironment.f1,
                           FcnEvaluator->objfun.tunableEnvironment.f3.m,
                           FcnEvaluator->objfun.tunableEnvironment.f3.num_params,
                           FcnEvaluator->objfun.tunableEnvironment.f3.int_method,
                           FcnEvaluator->objfun.tunableEnvironment.f3.N_dyn,
                           FcnEvaluator->objfun.tunableEnvironment.f3.int_steps,
                           FcnEvaluator->objfun.tunableEnvironment.f3.b,
                           FcnEvaluator->objfun.tunableEnvironment.f3.p_a1,
                           FcnEvaluator->objfun.tunableEnvironment.f3.p_a2,
                           FcnEvaluator->objfun.tunableEnvironment.f3.g,
                           FcnEvaluator->objfun.tunableEnvironment.f3.w1,
                           FcnEvaluator->objfun.tunableEnvironment.f3.w2,
                           FcnEvaluator->objfun.tunableEnvironment.f3.T_th,
                           TrialState->xstarsqp);
        idxFiniteLB = 1;
        ...
        if (idxFiniteLB == 1) {
          idxFiniteLB = computeConstraints_
            (FcnEvaluator->nonlcon.tunableEnvironment.f1,
             ...
             &FcnEvaluator->nonlcon.tunableEnvironment.f6, FcnEvaluator->mCineq,
                ...
                if (idxFiniteLB == 1) {
                  idxFiniteLB = computeConstraints_
                    (FcnEvaluator->nonlcon.tunableEnvironment.f1,
                     ...
                     FcnEvaluator->nonlcon.tunableEnvironment.f3,
                     FcnEvaluator->nonlcon.tunableEnvironment.f5,
                     &FcnEvaluator->nonlcon.tunableEnvironment.f6,

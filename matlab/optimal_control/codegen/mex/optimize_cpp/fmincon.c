             ...
             *output_lssteplength, real_T *output_firstorderopt)
{
  ...
  *fval = b_anon(fun_tunableEnvironment_f1, fun_tunableEnvironment_f3->m,
                 ...
                 fun_tunableEnvironment_f3->w1, fun_tunableEnvironment_f3->w2,
                 fun_tunableEnvironment_f3->T_th, TrialState.xstarsqp);
  idxFillStart = 1;
